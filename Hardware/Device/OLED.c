...
/*======== 重写：OLED写命令，复用软件I2C底层驱动 I2C_Driver ========*/
/**
 * @brief  OLED写命令
 * @param  Command 命令
 * @retval 无
...
{
    I2C_Start();
    I2C_SendByte(0x78);      // OLED I2C写地址
    I2C_SendByte(0x00);      // 控制字节 0x00:写命令
...
void OLED_WriteData(uint8_t *Data, uint8_t Count)
{
    ...
    I2C_Start();
    I2C_SendByte(0x78);      // OLED I2C写地址
    I2C_SendByte(0x40);      // 控制字节 0x40:写数据
    for(i = 0; i < Count; i++)
    {
        I2C_SendByte(Data[i]);
    }
